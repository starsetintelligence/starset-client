            ...
            {currentDatasets.map((dataset) => {
              ...
              return (
                <Link 
                  ...
                  className="relative bg-black border border-white/10 rounded-2xl p-8 hover:border-white/30 hover:shadow-[0_20px_40px_rgba(255,255,255,0.08)] transition-all duration-500 group hover:-translate-y-2 hover:scale-[1.02] flex flex-col cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black hover:z-50"
                >
