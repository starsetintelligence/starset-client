      ...
      <section className="bg-black py-20 md:py-32 px-6 md:px-[120px] relative z-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-8 hover:bg-[#111] hover:shadow-[0_20px_40px_rgba(255,255,255,0.15)] hover:border-white/30 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.03]">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {datasets.map((dataset) => {
              ...
              return (
                <Link to={`/dataset/${dataset.id}`} key={dataset.id} className="relative bg-black border border-white/10 rounded-2xl p-8 hover:border-white/50 hover:shadow-[0_20px_40px_rgba(255,255,255,0.15)] transition-all duration-500 group hover:-translate-y-2 hover:scale-[1.03] flex flex-col cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black hover:z-50">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center p-6 rounded-2xl border border-transparent hover:border-white/10 hover:bg-[#0A0A0A] hover:shadow-[0_20px_40px_rgba(255,255,255,0.08)] transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-black border border-white/20 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(255,255,255,0.05)]">
