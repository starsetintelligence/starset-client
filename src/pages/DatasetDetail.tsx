  ...
  return (
    <div className="pt-24 md:pt-32 pb-20 px-6 md:px-[120px] max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start mb-20">
        ...
        {/* Quick Metrics Card */}
        <TiltCard className="w-full lg:w-[400px] shrink-0">
          <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Features */}
        <TiltCard>
          <div className="bg-black/40 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-10 hover:border-white/30 hover:shadow-[0_20px_40px_rgba(255,255,255,0.08)] transition-all duration-500 h-full">
